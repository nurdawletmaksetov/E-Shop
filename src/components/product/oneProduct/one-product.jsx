...
const OneProduct = (props) => {
    const { title, price, image, stock, warrantyInformation, rating, reviews, id, returnPolicy, discountPercentage, shippingInformation } = props;
    ...
    return (
        <>
            <Card onMouseEnter={(e) => (e.currentTarget.style.boxShadow = '1px 1px 7px #C3C3C3')}
                    ...
                    >
                        <Flex gap="md">
                            ...
                            >
                                ...
                                />
                                <Link to={`/products/${id}`}>
                                    <Button fullWidth variant="outline" size="sm" c={"#000"} color={"gray"} fw={600}>
                            ...
                            <Flex direction="column" w={"50%"}>
                                ...
                                <Title order={2} fw={"bold"} c="#7f4dff">${price} USD</Title>
